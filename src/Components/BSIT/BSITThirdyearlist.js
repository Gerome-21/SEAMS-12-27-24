      ...
      const fetchStudents = async () => {
        try {
          ...
          const firstYearBSITStudents = response.data.filter(student => {
            ...
            return student.yearlevel === "3rd Year" && student.course === "BSIT";
          });
        ...
        <div className="firstyearlist-leftcont-box">
          ...
          <div className="firstyearlist-addeventForm">
            ...
            <div className="firstyearlist-eventDetails-box">
              <h4 className="firstyearlist-addeventformH4">(BSIT) Third Year</h4>
            </div>
                ...
                <tbody>
                  {students.map((data, index) => (
                    <tr key={index}>
                      ...
                      <td>{data.skill}</td>
                      <td>
                        <Link to={`updatethirdyear/${data.id}`} className='firstyearlist-updatebtn'>Update</Link>
...
export default BSITThirdyearlist