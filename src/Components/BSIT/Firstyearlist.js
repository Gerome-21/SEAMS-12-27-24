    ...
    const fetchStudents = async () => {
      try {
        ...
        const firstYearBSITStudents = response.data.filter(student => {
          ...
          return student.yearlevel === "1st Year" && student.course === "BSIT";
        });
      ...
      <div className="firstyearlist-leftcont-box">
        ...
        <div className="firstyearlist-addeventForm">
          ...
          <div className="firstyearlist-eventDetails-box">
            <h4 className="firstyearlist-addeventformH4">(BSIT) First Year</h4>
          </div>
          ...
          {loading ? (
            ...
            <p>No first-year BSIT students available.</p>
          ) : (
              ...
              <tbody>
                {students.map((data, index) => (
                  <tr key={index}>
                    ...
                    <td>{data.skill}</td>
                    <td className="firstyearlist-actions">
