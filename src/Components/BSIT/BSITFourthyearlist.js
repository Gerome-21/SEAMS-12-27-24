      ...
      const fetchStudents = async () => {
        try {
          ...
          const firstYearBSITStudents = response.data.filter(student => {
            ...
            return student.yearlevel === "4th Year" && student.course === "BSIT";
          });
        ...
        <div className="firstyearlist-leftcont-box">
          ...
          <div className="firstyearlist-addeventForm">
            ...
            <div className="firstyearlist-eventDetails-box">
              <h4 className="firstyearlist-addeventformH4">(BSIT) Fourth Year</h4>
            </div>
                ...
                <tbody>
                  {students.map((data, index) => (
                    <tr key={index}>
                      ...
                      <td>{data.skill}</td>
                      <td>
                        <Link to={`updatefourthyear/${data.id}`} className='firstyearlist-updatebtn'>Update</Link>
...
export default BSITFourthyearlist