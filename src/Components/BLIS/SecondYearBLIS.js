        ...
        const fetchStudents = async () => {
          try {
            ...
            const firstYearBSITStudents = response.data.filter(student => {
              ...
              return student.yearlevel === "2nd Year" && student.course === "BLIS";
            });
        ...
        <div className="firstyearlist-leftcont-box">
          ...
          <div className="firstyearlist-addeventForm">
            ...
            <div className="firstyearlist-eventDetails-box">
              <h4 className="firstyearlist-addeventformH4">(BLIS) Second Year</h4>
            </div>
                ...
                <tbody>
                  {students.map((data, index) => (
                    <tr key={index}>
                      ...
                      <td>{data.skill}</td>
                      <td>
                        <Link to={`updatesecondyearblis/${data.id}`} className='firstyearlist-updatebtn'>Update</Link>
